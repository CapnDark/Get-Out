...
namespace DitzeGames.Effects
{
    ...
    public class CameraEffects : MonoBehaviour
    {
        ...
        /// Amount of Shake
        /// </summary>
        public Vector3 Amount = new Vector3(1f, 1f, 1f);
        ...
        /// Do the shake
        /// </summary>
        public static void ShakeOnce(float duration = 0.5f, float speed = 10f, Vector3? amount = null, Camera camera = null, bool deltaMovement = true, AnimationCurve curve = null)
        {
            //set data
